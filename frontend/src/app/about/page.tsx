  ...
  return (
    <div className="bg-white flex flex-col justify-center w-full">
      ...
      <div className="bg-white overflow-hidden w-full relative">
        {/* Hero Section */}
        <div className="relative w-full h-[250px] md:h-[150px] lg:h-[300px] mx-auto mt-[85px]">
        ...
        <Card className="border-none shadow-none w-full max-w-[1252px] mx-auto mt-8 md:mt-12 lg:mt-[44px] px-4 md:px-8 lg:px-0">
          <CardContent className="p-0">
            <div className="flex flex-col w-full md:w-full items-start gap-2.5">
              <h2 className="font-['Plus_Jakarta_Sans',Helvetica] font-medium text-2xl md:text-3xl lg:text-[35px] ">
                <span className="text-[#0b2727]">Who </span>
                <span className="text-[#dd8256]">We Are?</span>
              </h2>
              <p className="font-['Plus_Jakarta_Sans',Helvetica] font-medium text-heading-color text-base md:text-lg ">
              ...
              <p className="font-['Plus_Jakarta_Sans',Helvetica] font-medium text-heading-color text-base md:text-lg tracking-[0] leading-[1.6] md:leading-[30px] mt-4">
        ...
        <Card className="border-none shadow-none w-full max-w-[1252px] mx-auto mt-8 md:mt-12 lg:mt-[50px] px-4 md:px-8 lg:px-0">
          <CardContent className="p-0">
            <div className="flex flex-col w-full items-start gap-2.5">
              <h2 className="font-['Plus_Jakarta_Sans',Helvetica] font-medium text-2xl md:text-3xl lg:text-[35px] tracking-[0] leading-normal">
                <span className="text-[#0b2727]">Our </span>
                <span className="text-[#dd8256]">Mission</span>
              </h2>
              <p className="font-['Plus_Jakarta_Sans',Helvetica] font-medium text-heading-color text-base md:text-lg tracking-[0] leading-[1.6] md:leading-[30px]">
